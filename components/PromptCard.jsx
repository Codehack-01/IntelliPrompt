...
const PromptCard = ({ post, handleEdit, handleDelete, handleTagClick }) => {
  ...
  return (
    <div className='prompt_card'>
      ...
      <p className='my-4 font-inter text-sm text-white'>{post.prompt}</p>
      <p
  ...
  return (
    <div className='prompt_card'>
      <div className='flex justify-between items-start gap-5'>
        ...
        <div className='copy_btn' onClick={handleCopy}>
          <Image
          src={copied === post.prompt ? '/assets/icons/tick.svg' : '/assets/icons/copy.svg'} alt='image' width={12} height={12}/>
        </div>
      </div>
